...
function get_safe_value($con,$str){
	if($str!=''){
		$str=trim($str);
		//mysqli_real_escape_strin----for security password
...
function generateShipRocketToken($con){
  ...
  // mysqli_query($con,"insert into shiprocket_token(token,added_on) values('$token','$added_on')");
...
function placeShipRocketOrder($con,$token,$order_id){
	...
	$html='';
	//product id sku from order details table
